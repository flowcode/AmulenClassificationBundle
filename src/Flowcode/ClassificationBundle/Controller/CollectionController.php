...
class CollectionController extends Controller
{
     ...
     *
     * @Route("/", name="admin_collection_create")
     * @Method("POST")
     * @Template("FlowcodeClassificationBundle:Collection:new.html.twig")
     */
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('admin_collection_show', array('id' => $entity->getId())));
        }
     ...
     *
     * @Route("/{id}", name="admin_collection_update")
     * @Method("PUT")
     * @Template("FlowcodeClassificationBundle:Collection:edit.html.twig")
     */
    ...
    public function deleteAction(Request $request, $id)
    {
        ...
        return $this->redirect($this->generateUrl('admin_collection'));
    }
